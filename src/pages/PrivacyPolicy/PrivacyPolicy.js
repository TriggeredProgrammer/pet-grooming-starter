...
const PrivacyPolicy = () => {
  return (
    <div className="container mt-1">
      <h5 className="text-center  pv-title mt-3 pt-5">Privacy Policy</h5>
      <div className="row mt-3">
        <div className="col-md-12">
          <div className="rte">
            <div className="spreate">
              <p className="p1">
                This SERVICE is provided by Dearpet at no cost and is intended
                for use as is.
              </p>
              <p className="p1">
              ...
              <p className="p1">
                ...
                in our Terms and Conditions, which is accessible at What are
                facts unless otherwise defined in this Privacy Policy.
              </p>
              <p className="p3">
              ...
              <p className="p4">
                We want to inform you that whenever you use my Service, in case
              ...
              <p className="p1">
                ...
                information, please contact me so that We will be able to do the
                necessary actions.
              </p>
              <p className="p6">
              ...
              <p className="p1">
                ...
                Policy, do not hesitate to contact me at support@dearpet.in.
              </p>
            </div>
          </div>
        </div>
