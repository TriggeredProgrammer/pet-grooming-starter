...
const Appointment = () => {
  return (
    <section className="bg-yellow-secondary py-12 lg:pb-12 lg:mt-32 relative min-h-[548px]">
      <div className="container mx-auto">
        <div>
          {/* image */}
          <div className="hidden w-full max-w-[790px] mx-auto lg:flex justify-center">
            <img src={DogImg} alt="dog appointment" className="img-fluid" />
          </div>
          <form className="bg-yellow py-8 px-6 w-full max-w-[790px] h-[500px] mx-auto lg:-mt-5 rounded-[60px] text-center flex flex-col justify-start items-center gap-y-4">
            ...
            <input  className="input-control" type="text" placeholder="Phone" />
